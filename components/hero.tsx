      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        <div className="flex flex-col items-center text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-border/50 bg-muted/50 px-4 py-1.5 text-sm text-muted-foreground backdrop-blur-sm">
            ...
            Women, Parenting & Life
          </div>

          <h1 className="max-w-3xl text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
            <span className="bg-gradient-to-r from-pink-500 via-rose-500 to-pink-500 bg-[length:200%_auto] bg-clip-text text-transparent animate-[gradient_3s_ease_infinite]">
              Kevin&apos;s
            </span>
            <br />
            <span className="text-foreground">Life Blog</span>
          </h1>

          <p className="mt-6 max-w-xl text-lg text-muted-foreground">
            여성, 육아, 일과 삶의 균형에 대한 따뜻하고 실용적인 이야기입니다.
            <br className="hidden sm:block" />
            엄마, 아내, 그리고 한 명의 여성으로서의 삶을 함께 나눕니다.
          </p>
